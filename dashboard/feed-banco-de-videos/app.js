...
document.addEventListener("DOMContentLoaded", () => {
  ...
  iniciar().catch((error) => {
    console.error("Erro na tela feed-banco-de-videos:", error);
    setScreenMessage(error.message || "Nao foi possivel carregar o feed do banco de videos.");
  });
});
